...
CMD="./mon-put-instance-data.pl --mem-util --mem-used --mem-avail --swap-util --swap-used --disk-path=$DISK_PATH --disk-space-util --disk-space-avail --disk-space-used --auto-scaling"
